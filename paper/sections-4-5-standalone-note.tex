...
\author{Roberto Rubboli \and Erkka Haapasalo \and Marco Tomamichel}
\date{}
...
\begin{lemma}
\label{lem:Minkowski}
Let $\alpha\in\R\setminus\{0\}$.  The function, defined on
$\R^d_{>0}$,
\begin{equation}
...
\bibitem{bullen2013handbook}
P.~S. Bullen,
\emph{Handbook of Means and Their Inequalities}, Vol.~560
(Springer Science \& Business Media, 2013),
doi:\href{https://doi.org/10.1007/978-94-017-0399-4}{10.1007/978-94-017-0399-4}.

\bibitem{mu21_renyi}
X.~Mu, L.~Pomatto, P.~Strack, and O.~Tamuz,
``From Blackwell dominance in large samples to R\'enyi divergences and back again,''
\emph{Econometrica} \textbf{89}, 475--506 (2021),
doi:\href{https://doi.org/10.3982/ECTA17548}{10.3982/ECTA17548}.

\bibitem{farooq2024matrix}
M.~U. Farooq, T.~Fritz, E.~Haapasalo, and M.~Tomamichel,
``Matrix majorization in large samples,''
\emph{IEEE Transactions on Information Theory} \textbf{70}, 3118--3144 (2024),
doi:\href{https://doi.org/10.1109/TIT.2024.3352088}{10.1109/TIT.2024.3352088}.

\bibitem{rubboli2026complete}
R.~Rubboli, E.~Haapasalo, and M.~Tomamichel,
``A complete characterisation of conditional entropies,''
\emph{Ultra Lean} revision, 60-page manuscript supplied with this note (2026).
All equation numbers in this note refer to that revision.  An earlier public
version is available as
\href{https://arxiv.org/abs/2601.23213}{arXiv:2601.23213 [cs.IT]}.
