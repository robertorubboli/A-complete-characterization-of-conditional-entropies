...
canonical Lean name.  Thirty-one rows directly package the stated formal
content; the status column identifies the single qualified row.  The
presentation is deliberately theorem-facing: it separates public conclusions,
paper-level ingredients, and proved reusable infrastructure.
\end{abstract}
...
integral for orders zero, one, and two; hence only Proposition~5.10 remains
qualified.
...
semantic status of the single qualified row is stated explicitly above.  The
