...
\section*{Relation to the concise companion}
\addcontentsline{toc}{section}{Relation to the concise companion}

Ref.~\cite{rubboli2026parametersConcise} is the statement-and-main-ideas layer
of this paper.  The present paper proves the same numbered statements in the
same order.  Sections~\ref{sec:sufficient-conditions}
and~\ref{sec:necessary-conditions} keep the logical obstruction and the witness
...
This subsection supplies the full proof of Proposition~1.4 of the concise
companion.
...
This subsection proves Propositions~1.5--1.6 and Remark~1.7 of the concise
companion.
...
We now prove Propositions~2.7--2.8 of the concise companion.  The negative
...
We finally prove Propositions~2.9--2.10 of the concise companion.  It is useful
...
\clearpage
\appendix
\section{Technical foundations for the concise classification}
