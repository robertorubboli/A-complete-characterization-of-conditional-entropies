...
implies its concise main-paper version. It also supplies the real-power
...
stronger endpoint-aware form that directly implies the concise version.  The
...
Section~\ref{sec:channel-lift}.  This order explains how the concise proof ideas
