% This file has two modes.  It compiles as a standalone extract by default.
% If the host manuscript defines \IntegratedParameterSections before inputting
% it, only the body of Sections 4 and 5 is emitted.
\ifdefined\IntegratedParameterSections
...
\newcommand{\ParameterMainForms}{the candidate families of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainTemperateForm}{Eq.~(67) and Proposition~3.6 of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainLift}{Proposition~A.1 and Lemma~A.3 of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainDerivationLift}{Lemmas~A.2 and~A.4 of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainDerivationRepresentation}{Eq.~(78) and Proposition~3.7 of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainSemiring}{the conditional-majorization semiring of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainNormalization}{the normalization of Definition~6.1 in Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainDerivationDefinition}{of Definition~6.1 in Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterMainFinalFamilies}{the candidate families in Eqs.~(173)--(176) of Ref.~\cite{rubboli2026complete}}
\newcommand{\ParameterSpanOrigin}{is imported from \ParameterMainDerivationRepresentation}
...
\begin{abstract}
This standalone document compiles Sections~4 and~5 of the main manuscript as a
concise, human-readable extract.  It gives the sufficient and necessary parameter
conditions for the conditional entropies introduced in
Ref.~\cite{rubboli2026complete}, covering general measures, both tropical endpoints,
and derivations without assuming finiteness of the singular weighted moment at
$\alpha=1$.
The proof sketches retain the central ideas---finite-support factorization, common
discretization, and localized high-dimensional counterexamples---while omitting the
long analytic calculations.  Complete analytic proofs are given in
Ref.~\cite{rubboli2026parametersFull}, and their formal counterparts are documented in
...
The general forms of the homomorphisms and derivations in
Ref.~\cite{rubboli2026complete} depend on a finite measure: in the temperate case
one may write it as
