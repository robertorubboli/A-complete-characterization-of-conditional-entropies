...
\paragraph*{Companion proofs of the parameter classification.}
The sufficient and necessary parameter conditions used below are presented
concisely in Ref.~\cite{rubboli2026parametersConcise}, proved with full
analytic detail in Ref.~\cite{rubboli2026parametersFull}, and accompanied by
a standalone machine-checked Lean formalization in
Ref.~\cite{rubboli2026parametersLean}. The present paper records the resulting
exact admissible sets in Definitions~\ref{def: D} and~\ref{def: D_infty}.
