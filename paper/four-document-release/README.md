...
26 August 2026. All four documents use the same RevTeX layout, shared
...
1. `main-paper.tex` is the canonical 46-page journal manuscript. It
   ...
   integrates concise Sections 4 and 5 directly. Those sections give the
...
2. `sections-4-5-concise.tex` is a standalone extract of the manuscript's
   Sections 4 and 5. It preserves their structure, notation, statements,
   vectors, constants, and concise proof style, but can be compiled and read
   independently.
3. `sections-4-5-full-details.tex` is the complete proof supplement. It expands
...
4. `lean-formalization-note.tex` is the Lean formalization supplement. It
...
The canonical manuscript determines all statement numbering. The concise
extract preserves it, and the complete-proof and Lean supplements mirror it.

## Overleaf

Upload this entire folder to one Overleaf project. Choose any one of the four
...
The `pdf` subfolder contains compile-verified PDFs of the four documents: the
main manuscript is 46 pages, the complete-proof supplement is 47 pages, the
concise extract is 16 pages, and the Lean supplement is 4 pages. The
