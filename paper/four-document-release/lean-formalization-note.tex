...
rubboli2026parametersFull}. It gives a compact theorem-facing proof map, a
...
The repository contains three complementary diagrams at different levels of
detail. Figure~\ref{fig:lean-dependencies} is the \emph{theorem-facing proof
...
to dependent. The main-paper Lean appendix contains a third, coarser
\emph{condensed two-branch architecture overview} using that same source-level
arrow direction.
...
\end{tikzpicture}
\caption{Theorem-facing proof map for the four-document release. Every displayed
...
reverse of the source-dependency convention in the module-group graph. Color
