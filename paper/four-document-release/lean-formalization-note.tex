...
Sections~4 and~5 of Ref.~\cite{rubboli2026complete}, with complete analytic
proofs in Ref.~\cite{rubboli2026parametersFull}. It gives a compact
...
The formal development follows Sections~4 and~5 of the main paper and the
full analytic proofs in Ref.~\cite{rubboli2026parametersFull}. It covers the endpoint-aware R\'enyi parameter,
...
remark is the number in Sections~4 and~5 of the main paper,
Ref.~\cite{rubboli2026complete}. The full-proof paper,
Ref.~\cite{rubboli2026parametersFull}, mirrors their order, notation, and
numbering, using strengthened formulations where endpoint or closure details
are made explicit.
...
map}: it connects public conclusions to numbered manuscript results and
...
\node[paper] (suff) at (-4.1,-1.8)
  {Sufficiency\\Statements~4.4--4.8};
...
displayed statement number is the number in Sections~4 and~5 of the main paper,
Ref.~\cite{rubboli2026complete}; the full-proof paper reproduces the same
numbering. Arrows point from a result to ingredients used in its proof, the
...
numbering of Sections~4 and~5 of the main paper,
Ref.~\cite{rubboli2026complete}. The full-proof paper uses the same
...
remark numbers are those of Sections~4 and~5 of the main paper,
Ref.~\cite{rubboli2026complete}; the full-proof paper uses the same numbering.}
\label{tab:lean-correspondence}
\begin{tabular}{L{0.25\textwidth}L{0.49\textwidth}L{0.18\textwidth}}
\toprule
Manuscript statement & Lean declaration & Status\\
\midrule
Lemma~4.1: power-mean curvature &
\LeanDecl{finiteHolder}; \LeanDecl{powerCurvature};
\LeanDecl{parameterPowerCurvature} & \Formalized\\
\addlinespace
Lemma~4.2: monomial curvature &
\LeanDecl{affineMonomialCurvaturePackage} & \Formalized\\
\addlinespace
Lemma~4.3: finite-support sufficiency &
\LeanDecl{finiteSufficiency} & \Formalized\\
\addlinespace
Proposition~4.4: general temperate sufficiency &
...
\addlinespace
Proposition~4.6: positive-tropical sufficiency &
...
from Sections~4 and~5 of the main paper).}\par\smallskip
\begin{tabular}{L{0.25\textwidth}L{0.49\textwidth}L{0.18\textwidth}}
\toprule
Manuscript statement & Lean declaration & Status\\
\midrule
Remark~4.7: exact tropical endpoint families &
Tropical fields of \LeanDecl{mainClassification} &
\Formalized\ (split API)\\
\addlinespace
Proposition~4.8: derivation sufficiency &
\LeanDecl{derivationSufficiency} & \Formalized\\
\addlinespace
Proposition~5.1: positive necessity &
\LeanDecl{positiveNecessity};
\LeanDecl{positiveTemperateProbabilityNecessity} &
\Formalized\ (split API)\\
\addlinespace
Proposition~5.2: negative Shannon atom with upper support &
\LeanDecl{negativeShannonObstruction} & \Formalized\\
\addlinespace
Proposition~5.3: truncated exceptional-moment bound &
...
Manuscript statement & Lean declaration & Status\\
\midrule
Remark~5.4: homogeneity and channel lift &
...
\addlinespace
Remark~5.5: compensated two-column witness &
...
\addlinespace
Proposition~5.6: complete exceptional negative branch (unique upper point,
one-sided finiteness, and moment bound) &
...
\Formalized\ (split API)\\
\addlinespace
Proposition~5.9: derivation necessity &
\LeanDecl{derivationNecessity} & \Formalized\\
\addlinespace
Proposition~5.10: represented derivations &
