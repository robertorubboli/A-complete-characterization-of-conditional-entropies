...
Ref.~\cite{rubboli2026complete}. It mirrors the order, notation, and numbering
used there; where useful, a statement is given in a strengthened form that
implies the corresponding main-paper statement. It also supplies the real-power
...
statements in the same order, notation, and numbering.  A few are stated in a
...
This subsection proves Propositions~4.5--4.6 and Remark~4.7 of the main paper.
...
Thus the positive tropical family contains only the point mass at $\alpha=0$.
In contrast, every point mass belongs to the negative tropical family, under
the alternatives of Proposition~\ref{prop:negative-tropical-sufficient}.
\end{remark}

\subsection{Sufficient conditions for derivations}

This subsection proves Proposition~4.8 of the main paper.
...
versions of Statements~5.1--5.6 of the main paper, in the same order and with
...
We now prove Propositions~5.7--5.8 of the main paper.  The negative
branch uses the same Shannon and three-block witnesses as the temperate case,
with an additional exact stationarity correction.  The positive branch uses a
separate binary fixed-face witness.
...
We finally prove Propositions~5.9--5.10 of the main paper.  It is useful
to treat the full barycentre at once. Let $\nu$ be a finite positive measure and define on an unnormalised column
\begin{equation}
 D_\nu(\vec x)
 :=\|\vec x\|_1
