...
| Tropical necessity | `PositiveTropicalNecessity`, `NegativeTropicalShannonNecessity`, `NegativeTropicalNecessity` | The positive Dirac conclusion and the negative lower-support/single-exceptional conclusion, including the Shannon upper-atom obstruction. |
